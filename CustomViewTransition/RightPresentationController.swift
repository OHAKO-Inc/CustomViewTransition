...
class RightPresentationController: UIPresentationController {
    ...
    override func frameOfPresentedViewInContainerView() -> CGRect {
        ...
        return CGRectMake(containerView.bounds.width / 6.0, containerView.bounds.height / 6.0, containerView.bounds.width * 2.0 / 3.0, containerView.bounds.height * 2.0 / 3.0)
    }
}
